...
export default function MetaPage() {
  return (
    <main className="min-h-screen bg-black text-white overflow-x-hidden">
          ...
          <div className="flex w-full items-start gap-[184px] py-[42px]" style={{ fontFamily: leagueSpartan }}>
            ...
            <div className="flex items-start gap-[80px] ml-auto">
              <div className="flex flex-col gap-[14px]">
                ...
                <p className="text-[32px] font-light leading-[42px]">1.5 months</p>
              </div>
              <div className="flex flex-col gap-[14px]">
                <p className="text-[18px] font-light leading-none">Platforms</p>
                <p className="text-[32px] font-light leading-[42px]">Desktop</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="relative w-full px-[37px] pt-[36px] pb-[125px]">
      ...
      <section className="w-full pb-[310px] px-8">
        <CardStack
          items={oldFlowItems}
          cardWidth={520}
          cardHeight={371}
      ...
      <section className="px-[37px] pt-12 pb-32 w-full flex justify-end">
      ...
      <section className="px-8 pb-[178px] max-w-[1600px] mx-auto w-full -mt-5">
        ...
        <div className="grid grid-cols-[280px_1fr] gap-12 mb-6">
          ...
          <div className="flex justify-between">
            <p className="font-[family-name:var(--font-league-spartan)] font-bold text-[24px] text-white/60 tracking-[-0.24px]">Today</p>
            <p className="font-[family-name:var(--font-league-spartan)] font-bold text-[24px] text-white/60 tracking-[-0.24px]">H1 2025</p>
          </div>
        </div>
        ...
        <div className="space-y-14">
          ...
          <div className="grid grid-cols-[280px_1fr] gap-12 items-center pt-4">
            <h3 className="font-[family-name:var(--font-league-spartan)] text-[40px] leading-[1.1] font-normal">
              Savings
            </h3>
            <p className="font-serif text-[clamp(64px,8vw,96px)] leading-[1] tracking-[-0.96px]">
              ~ $20M/yr.
            </p>
          </div>
        </div>
      ...
      <section className="w-full flex justify-center pb-32 px-8">
        <div className="w-full max-w-[1417px]">
          <MiNewFlowSlideshow />
        </div>
      </section>

      <section className="w-full grid grid-cols-1 lg:grid-cols-2 gap-7 px-7 pb-32 max-w-[1857px] mx-auto">
        <div className="flex flex-col gap-12">
          <div
            className="relative h-[512px] rounded-[8px] overflow-hidden flex items-center justify-center"
            style={{
              background:
          ...
          >
            <Image
              ...
              aria-hidden
            />
            <div className="relative z-10 px-12 w-full flex justify-center">
              <PromoCard />
            </div>
          </div>

          <div className="flex flex-col gap-[56px]" style={{ fontFamily: leagueSpartan }}>
            <div className="flex flex-col gap-[14px]">
            ...
            <div className="flex items-center gap-[25px]">
              <Link
                ...
                style={{ fontFamily: "var(--font-league-spartan)", lineHeight: 1, paddingTop: '18px', paddingBottom: '14px' }}
              >
                More work
              </Link>
              <a
                ...
                className="inline-flex items-center justify-center rounded-full border border-[#919191] px-[30px] py-[16px] text-[32px] font-normal whitespace-nowrap text-white transition-colors duration-150 hover:border-white"
                style={{ fontFamily: "var(--font-league-spartan)", lineHeight: 1, paddingTop: '18px', paddingBottom: '14px' }}
              >
                Prototype
              </a>
        ...
        <ImageSpotlight config={{ className: 'rounded-[8px] bg-[#6425b5] min-h-[1116px] w-full', spotlightSize: 104 }}>
          <Image
            ...
            aria-hidden
          />
          <div className="relative z-10 flex items-start justify-center pt-40 px-4 w-full h-full">
            <Image
              src={singlePage}
