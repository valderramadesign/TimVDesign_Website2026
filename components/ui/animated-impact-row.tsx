...
export function AnimatedImpactRow({
  ...
  return (
    <div ref={ref} className="grid grid-cols-[280px_1fr] gap-12 items-center">
      <h3 className="font-[family-name:var(--font-league-spartan)] text-[40px] leading-[1.1] font-normal whitespace-pre-line">
        {label}
      </h3>
      <div>
        <div className="relative h-[89px] w-full rounded-[20px] bg-[rgba(217,217,217,0.2)]">
          {/* inner area with 10px inset on left, top, bottom */}
          <div className="absolute left-[10px] top-[10px] bottom-[10px] right-0">
            <div
            ...
            <motion.div
              className="absolute top-0 h-full bg-[#cef252] rounded-[20px] flex items-center justify-end pr-6 overflow-hidden"
              style={{ left: `${todayPct}%` }}
              initial={{ width: 0 }}
